        ...
        var _nextNodes3 = state.nodes.reduce(function (res, node) {
          if (node.id === targetNodeId) {
            ...
            if (foundHandleSource) {
              //check connections
              var connected = state.edges.find(function (edge) {
                return edge.source === targetNodeId && edge.sourceHandle === foundHandleSource.id;
              });
              ...
              //check connections
              var _connected = state.edges.find(function (edge) {
...
export { ArrowHeadType, index as Background, BackgroundVariant, ConnectionLineType, ConnectionMode, ControlButton, index$1 as Controls, EdgeText$1 as EdgeText, Handle$1 as Handle, index$2 as MiniMap, NodeIdContext, PanOnScrollMode, Position, ReactFlowProvider, addEdge, getBezierPath, getConnectedEdges, getCenter as getEdgeCenter, getIncomers, getMarkerEnd, getOutgoers, getRectOfNodes, getSmoothStepPath, getTransformForBounds, isEdge, isNode, removeElements, updateEdge, useDispatch, useStore, useStoreActions, useStoreState, useTypedSelector, useUpdateNodeInternals, useZoomPanHelper };
